...
import br.com.poo2.trabalhoFinal.domain.game.Game;
import br.com.poo2.trabalhoFinal.domain.game.GameBuilder;
...
public class GameAppService implements IGameAppService {
    ...
    public List<PlayerInfo> getPlayerInfos() {
        return game.getPlayers()
                .map(p -> new PlayerInfo(p.getId(), p.getName()))
    ...
    public PlayerInfo getCurrentPlayer() {
        ...
        return new PlayerInfo(currentPlayer.getId(), currentPlayer.getName());
    }
