package br.com.poo2.trabalhoFinal.ui.view;

import br.com.poo2.trabalhoFinal.application.IGameAppService;
import br.com.poo2.trabalhoFinal.application.PlayerInfo;
import br.com.poo2.trabalhoFinal.domain.card.Card;
import br.com.poo2.trabalhoFinal.domain.card.CardType;
import br.com.poo2.trabalhoFinal.domain.card.WildCard;
import br.com.poo2.trabalhoFinal.domain.common.DomainEvent;
import br.com.poo2.trabalhoFinal.domain.common.DomainEventPublisher;
import br.com.poo2.trabalhoFinal.domain.common.DomainEventSubscriber;
import br.com.poo2.trabalhoFinal.domain.game.DealerService;
import br.com.poo2.trabalhoFinal.domain.game.events.CardDrawn;
import br.com.poo2.trabalhoFinal.domain.game.events.CardPlayed;
import br.com.poo2.trabalhoFinal.domain.game.events.GameOver;
import br.com.poo2.trabalhoFinal.ui.common.StyleUtil;
...
public class PlayerView extends JPanel implements DomainEventSubscriber {
    ...
    public PlayerView(PlayerInfo player, IGameAppService appService) {
        this.player = player;
